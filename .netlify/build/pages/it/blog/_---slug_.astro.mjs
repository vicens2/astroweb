...
import 'kleur/colors';
import { g as getCollection } from '../../../chunks/_astro_content_k-3_lzHx.mjs';
import { $ as $$MarkdownPostLayout } from '../../../chunks/MarkdownPostLayout_CRucYgv0.mjs';
...
async function getStaticPaths() {
  ...
  }).filter((entry) => entry.params.lang === "it");
}
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const seo = {
    ...
    canonical: `https://mintaka.co/it/blog/${entry.slug}/`,
    openGraph: {
      url: entry.slug,
      title: entry.data.title,
...
}, "C:/Users/vicens.juan/astroweb/src/pages/it/blog/[...slug].astro", void 0);

const $$file = "C:/Users/vicens.juan/astroweb/src/pages/it/blog/[...slug].astro";
