...
export const ui = {
	en: {
		...
		homepage: "Homepage",
		tagline:
			"Transforma tus eventos en recuerdos eternos con nuestro fotomatón y video 360º. Capturamos sonrisas, emociones y detalles únicos para revivir cada instante junto a quienes más quieres.",
	...
	it: {
		...
		"faqs.answer10":
			"Seguiamo convenzioni di nominazione rigorose, ma a volte ci ritroviamo con classici come 'finalFinalVersionForReal' e 'thisWillDefinitelyWork'.",
		"nuestros_servicios": "Nuestros Servicios",
		"catalog.viewFullCatalog": "Ver catálogo completo",
		"catalog.fullCatalog": "Catálogo Completo",
		"catalog.filterByCategory": "Filtra por categoría para encontrar exactamente lo que necesitas",
